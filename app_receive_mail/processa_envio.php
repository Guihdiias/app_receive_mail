<?php
	...
	class Mensagem {
		...
		public function mensagemValida() {
			if(empty($this->de) || empty($this->assunto) || empty($this->mensagem)) {
				return false;
			}
	...
	try {
	    ...
	    //Recipients
	    $mail->setFrom('emailde@gmail.com', 'Web Completo Remente');
	    $mail->addAddress('emailpara@gmail.com');     // Add a recipient
	    ...
	    $mail->Subject = $mensagem->__get('de');
